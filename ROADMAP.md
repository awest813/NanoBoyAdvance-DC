...
- [x] **Phase C** — Affine/rotated sprite fast-mode scanline path (mirrors cycle-accurate math)
- [ ] **Phase C** — SH4-tuned inner loops (deferred until retail segment timers identify the hot loop)
